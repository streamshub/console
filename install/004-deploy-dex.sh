...
${KUBE} annotate serviceaccount dex -n ${NAMESPACE} --dry-run=client "serviceaccounts.openshift.io/oauth-redirecturi.dex=http://console-dex.${CLUSTER_DOMAIN}/callback" -o yaml \
  | ${KUBE} apply -n ${NAMESPACE} -f -
