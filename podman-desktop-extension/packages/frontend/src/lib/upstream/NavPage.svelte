...
<div class="flex flex-col w-full h-full shadow-pageheader bg-charcoal-600">
  <div aria-label="{title}" class="flex flex-col w-full h-full pt-4" role="region">
    <div aria-label="header" class="flex pb-2 px-5" role="region">
      <div class="flex flex-col w-full">
        ...
        <div class="flex flex-row w-full">
          ...
          <div class="flex flex-1 justify-end w-full">
            <div aria-label="additionalActions" class="w-full" role="group">
              {#if $$slots['additional-actions']}
                <div class="space-x-2 flex flex-nowrap justify-end">
    ...
    <div aria-label="content" class="flex w-full h-full {contentBackground} overflow-auto" role="region">
      {#if loading}
        <LinearProgress />
      {:else}
        <slot name="content" />
