...
describe("Home page", () => {
  ...
  test("Connection details should show URL", async () => {
  ...
  test("Data rows are present", async () => {
  ...
  test("Data cells in each row are present", async () => {
