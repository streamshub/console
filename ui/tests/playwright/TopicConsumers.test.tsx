...
test.describe("Topic Consumers", () => {
  test("Topic Consumers page should display table", async ({ page }) => {
    await page.goto(
      `./kafka/j7W3TRG7SsWCBXHjz2hfrg/topics/ifT6uNQ9QyeVSDEnd9S9Zg/consumer-groups`,
    );
