...
public class ConnectorFilterParams {
    ...
    public List<Predicate<Connector>> buildPredicates() {
        List<Predicate<Connector>> predicates = new ArrayList<>();

        if (nameFilter != null) {
            predicates.add(new FetchFilterPredicate<>(nameFilter, Connector::name));
        }
