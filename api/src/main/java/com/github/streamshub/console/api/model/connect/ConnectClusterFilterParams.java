...
public class ConnectClusterFilterParams {
    ...
    public List<Predicate<ConnectCluster>> buildPredicates() {
        List<Predicate<ConnectCluster>> predicates = new ArrayList<>();

        if (nameFilter != null) {
            predicates.add(new FetchFilterPredicate<>(nameFilter, ConnectCluster::name));
        }
