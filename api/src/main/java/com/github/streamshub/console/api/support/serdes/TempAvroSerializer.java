...
/**
 * Remove when https://github.com/Apicurio/apicurio-registry/pull/6793 is released.
 */
public class TempAvroSerializer<U> extends AbstractSerializer<Schema, U> {
    ...
    public TempAvroSerializer(SchemaResolver<Schema, U> schemaResolver) {
        super(schemaResolver);
    }

    TempAvroSerializer<U> setAvroDatumProvider(AvroDatumProvider<U> avroDatumProvider) {
