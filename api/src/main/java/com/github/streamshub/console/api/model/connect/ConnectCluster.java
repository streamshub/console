...
public class ConnectCluster extends JsonApiResource<ConnectCluster.Attributes, ConnectCluster.Relationships> implements PaginatedKubeResource {
    ...
    static class Relationships {
        @JsonProperty
        JsonApiRelationshipToMany connectorPlugins = new JsonApiRelationshipToMany();
        @JsonProperty
        JsonApiRelationshipToMany connectors = new JsonApiRelationshipToMany();
    }
    ...
    public JsonApiRelationshipToMany connectorPlugins() {
        return relationships.connectorPlugins;
    }

    public JsonApiRelationshipToMany connectors() {
        return relationships.connectors;
    }
}
