...
import com.github.streamshub.systemtests.cluster.exception.KubeClusterException.UnstableCluster;
import com.github.streamshub.systemtests.resources.kafka.KafkaNodePoolResource;
import com.github.streamshub.systemtests.resources.kafka.KafkaResource;
import com.github.streamshub.systemtests.resources.kafka.KafkaTopicResource;
import com.github.streamshub.systemtests.resources.kafka.KafkaUserResource;
...
public class AbstractST {
    ...
    private static void checkClusterStability() {
        if (!cluster.isClusterUp()) {
            throw new UnstableCluster();
        }
    }
}
