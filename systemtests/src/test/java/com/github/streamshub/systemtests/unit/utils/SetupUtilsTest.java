...
class SetupUtilsTest {
    ...
    void testGetYamlFileContent() {
        ...
        Exception exception = assertThrows(RuntimeException.class, () -> SetupUtils.getYamlContentFromUrl(invalidUrl));
        assertTrue(exception.getMessage().contains("Cannot download YAML content"));

        assertTrue(SetupUtils.getYamlContentFromUrl(validUrl).startsWith("# Generated by Fabric8 CRDGenerator, manual edits might get overwritten!"));
    }
}
