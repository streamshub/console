...
public class Constants {
    ...
    public static final int SELECTOR_RETRIES = 7;
    ...
    public static final int DEFAULT_TOPICS_PER_PAGE = 10;
    ...
    public static final String APICURIO_DEFAULT_ARTIFACT_VERSION = "1";
    // Artifact
