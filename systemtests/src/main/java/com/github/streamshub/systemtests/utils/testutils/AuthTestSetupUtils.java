                ...
                .withNewSecurity()
                    .addNewRole()
                        ...
                        .addNewRule()
                            ...
                            .withPrivileges(Rule.Privilege.GET, Rule.Privilege.LIST, Rule.Privilege.CREATE, Rule.Privilege.UPDATE)
                        .endRule()
                    .endRole()
                    .addNewRole()
                    ...
                    .endRole()
                    .addNewRole()
                        .withName(AuthTestConstants.READ_ONLY_ROLE_NAME)
                        .addNewRule()
                            .addToResources(
                                ResourceTypes.Kafka.TOPICS.value(),
                                ResourceTypes.Kafka.TOPIC_RECORDS.value(),
            ...
            .withNewSpec()
                ...
                .withNewSecurity()
                    ...
                    .addNewSubject()
                        ...
                        .addToRoleNames(AuthTestConstants.READ_ONLY_ROLE_NAME)
                    .endSubject()
                    .addNewSubject()
                        .withClaim(AuthTestConstants.CLAIM_GROUPS)
                    ...
                    .addNewRole()
                        ...
                        .addNewRule()
                            .withResources(ResourceTypes.Global.KAFKAS.value())
                            .withResourceNames(AuthTestConstants.TEAM_ADMIN_KAFKA_NAME)
                            .withPrivileges(Rule.Privilege.ALL)
                        .endRule()
                    .endRole()
                    .addNewRole()
