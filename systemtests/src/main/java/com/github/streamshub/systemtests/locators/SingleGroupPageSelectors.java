...
public class SingleGroupPageSelectors {
    ...
    public static final String SGPS_RESET_PAGE_OFFSET_DRY_RUN_BUTTON = "body.pf-v6-c-backdrop__open > div.pf-v6-c-backdrop:nth-of-type(2) > div.pf-v6-l-bullseye > div.pf-v6-c-modal-box > footer.pf-v6-c-modal-box__footer > button.pf-v6-c-button:nth-of-type(2) > span.pf-v6-c-button__text";
