...
public class MessagesPageSelectors {
    ...
    public static final String MPS_TPF_RESET_BUTTON = "div.pf-v6-c-toolbar button[aria-label=\"Reset\"]";
    ...
    public static final String MPS_SEARCH_RESULTS_TABLE_ITEMS = new CssBuilder()
            .withElementTable()
            .withAriaLabel("Messages table")
            .withDesc()
            .withElementTbody()
            .withDesc()
            .withElementTr()
    ...
    private static CssBuilder getTableRowCells(int nthRow) {
        return new CssBuilder(MPS_SEARCH_RESULTS_TABLE_ITEMS).nth(nthRow).withElementTd();
    }
    ...
    public static String getTableRowItem(int nthRow, String dataLabel) {
