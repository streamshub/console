...
if [ -z "${2-}" ]; then echo "ERROR: KEYCLOAK_HOSTNAME (arg 2) is missing"; exit 1; fi
if [ -z "${3-}" ]; then echo "ERROR: STORE_PASS (arg 3) is missing"; exit 1; fi
if [ -z "${4-}" ]; then echo "ERROR: TRUST_STORE_FILE_PATH (arg 4) is missing"; exit 1; fi
