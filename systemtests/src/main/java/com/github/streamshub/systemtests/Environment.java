...
public class Environment {
    ...
    public static final String CONSOLE_OPERATOR_BUNDLE_URL = ENVS.getOrDefault("CONSOLE_OPERATOR_BUNDLE_URL", null);
    ...
    public static final String TEST_LOG_DIR = ENVS.getOrDefault("TEST_LOG_DIR", USER_PATH + "/../systemtests/target/logs/");
    ...
    public static final String SCREENSHOTS_DIR = ENVS.getOrDefault("SCREENSHOTS_DIR", USER_PATH + "/screenshots");
