...
public class Environment {
    ...
    public static final String CONSOLE_OPERATOR_BUNDLE_URL = ENVS.getOrDefault("CONSOLE_OPERATOR_BUNDLE_URL", USER_PATH  + "/../install/console-operator/non-olm/console-operator.yaml");
